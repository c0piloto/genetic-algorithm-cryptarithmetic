package etapa3.var02_popsize;

import etapa3.core.*;

// Variação onde o tamanho da população foi aumentado, de 140 para 180
// Conseguimos um rate de convergência de ~31% e o tempo de ~2.06 em média o que significa
// que está bem no limite dos 50% de aumento de tempo
// pode passar do limite mas em média não vai passar
public class Var02 {
  ...
  private static final int POP_SIZE = 180;
