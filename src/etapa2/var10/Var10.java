package etapa2.var10;

import etapa2.core.*;
// alteração pro teste 10: 120 individuos na população com uma taxa de mutação de 70%
// Média de Fitness: 0,45
// Média de Convergência: 96,20%
//Média de Tempo médio: 1,465 ms
public class Var10 {
  private static final int RUNS = 1000;
  private static final double MUTATION_RATE = 0.70; // TM2
